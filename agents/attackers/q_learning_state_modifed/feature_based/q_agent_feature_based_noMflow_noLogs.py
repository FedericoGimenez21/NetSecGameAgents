...
if __name__ == '__main__':
    ...
    parser.add_argument("--disable_mlflow", help="Disable all MLflow logging and reporting", action='store_true', default=False)
    ...
    #desactivar logg
    # actions_logger.addHandler(logging.NullHandler())
    ...
    # Context manager for MLflow (use nullcontext if disabled)
    from contextlib import nullcontext
    mlflow_context = mlflow.start_run(run_name=experiment_name + f'. ID {args.experiment_id}') if not args.disable_mlflow else nullcontext()
