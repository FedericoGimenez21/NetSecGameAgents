...
def objective_function(trial, base_config):
    ...
    population_size = trial.suggest_int('population_size', 5, 6)
    n_generations = trial.suggest_int('n_generations', 2, 3)
    ...
    test_episodes = trial.suggest_int('test_episodes', 25,30)
